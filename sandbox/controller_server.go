...
func (p *controllerServer) Start(ctx context.Context, req *api.ControllerStartRequest) (*api.ControllerStartResponse, error) {
	in, err := SandboxFromProto(req.Sandbox)
	if err != nil {
...
func (p *controllerServer) Shutdown(ctx context.Context, req *api.ControllerShutdownRequest) (*types.Empty, error) {
...
func (p *controllerServer) Pause(ctx context.Context, req *api.ControllerPauseRequest) (*types.Empty, error) {
...
func (p *controllerServer) Resume(ctx context.Context, req *api.ControllerResumeRequest) (*types.Empty, error) {
...
func (p *controllerServer) RemoveContainer(ctx context.Context, req *api.ControllerRemoveContainerRequest) (*types.Empty, error) {
...
func (p *controllerServer) Ping(ctx context.Context, req *api.ControllerPingRequest) (*types.Empty, error) {
